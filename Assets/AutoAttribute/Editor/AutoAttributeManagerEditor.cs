...
{
    private AutoAttributeManager _autoAttributeManager;

    private AutoAttributeManager AutoAttributeManager_Instance
    {
        get
        {
			if(_autoAttributeManager == null){
				_autoAttributeManager = GameObject.FindObjectOfType<AutoAttributeManager>();
				Debug.Assert(_autoAttributeManager != null);
			}
            return _autoAttributeManager;
        }
    }
